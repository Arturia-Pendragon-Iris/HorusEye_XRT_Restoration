...
fbp_recon = FBP_ASTRA(astra_proj_geom, astra_vol_geom, astra_proj_clean)
sirt_recon = SIRT_ASTRA(astra_proj_geom, astra_vol_geom, astra_proj_clean, iter=500)
sart_recon = SART_ASTRA(astra_proj_geom, astra_vol_geom, astra_proj_clean, iter=500)
