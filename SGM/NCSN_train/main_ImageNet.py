...
#import runners.aapm_runner_CTtest_10_noconv
#import runners.model
#import runners.aapm_runner_traindataCT_10_noconv
print(0)
...
def parse_args_and_config():
    ...
    # parse config file
    if not args.test:
        with open(os.path.join('NCSN_train/configs', args.config), 'r',encoding='UTF-8') as f:
