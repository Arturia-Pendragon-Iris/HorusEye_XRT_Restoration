...
from restoration_task.SR.utils import TrainSetLoader_SR
...
def train():
    ...
    for epoch in range(1, opt.nEpochs + 1):
        print(epoch)
        training_set = TrainSetLoader_SR("/data/Train/HorusEye/images")
...
def save_checkpoint(model, epoch, path):
    model_out_path = os.path.join(path, "scratch_SR.pth")
