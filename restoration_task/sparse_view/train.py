...
from restoration_task.sparse_view.utils import TrainSetLoader_sparse
...
def train():
    ...
    for epoch in range(1, opt.nEpochs + 1):
        print(epoch)
        training_set = TrainSetLoader_sparse("/data/Train/HorusEye/images")
...
def save_checkpoint(model, epoch, path):
    model_out_path = os.path.join(path, "scratch_sparse.pth")
